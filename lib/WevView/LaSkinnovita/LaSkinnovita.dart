...
//------------------------------------START-----------------------------------//
class LaSkinnovita extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagLaSkinnovita.toString();
  @override
  LaSkinnovitaState createState() => new LaSkinnovitaState();
}
//-----------------------------------SplashScreenState------------------------//
class LaSkinnovitaState extends State<LaSkinnovita> {
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Text(
          GlobalFlag.LaSkinnovitas.toString(),
      ...
      body:WebView(
        initialUrl: GlobalFlag.LaSkinnovitasWebView,
