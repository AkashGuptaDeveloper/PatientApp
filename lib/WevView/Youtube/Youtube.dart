...
class Youtube extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagYoutube.toString();
  @override
  YoutubeState createState() => new YoutubeState();
}
//-----------------------------------SplashScreenState------------------------//
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      body:WebView(
        initialUrl: GlobalFlag.YoutubeWebView,
