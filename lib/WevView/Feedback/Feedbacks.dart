...
class Feedbacks extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagFeedbacks.toString();
  @override
  FeedbacksState createState() => new FeedbacksState();
}
//-----------------------------------SplashScreenState------------------------//
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      body:WebView(
        initialUrl: GlobalFlag.FeedbackWebView,
