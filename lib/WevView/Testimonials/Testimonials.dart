...
class Testimonials extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagTestimonials.toString();
  @override
  TestimonialsState createState() => new TestimonialsState();
}
//-----------------------------------SplashScreenState------------------------//
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Text(
          GlobalFlag.Testimonials.toString(),
      ...
      body:WebView(
        initialUrl: GlobalFlag.TestimonialsWebView,
