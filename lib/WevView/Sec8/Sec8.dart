...
//------------------------------------START-----------------------------------//
class Sec8 extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagSec8.toString();
  @override
  Sec8State createState() => new Sec8State();
}
//-----------------------------------SplashScreenState------------------------//
class Sec8State extends State<Sec8> {
