...
//------------------------------------START-----------------------------------//
class PayCustomer extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagPayCustomer.toString();
  @override
  PayCustomerState createState() => new PayCustomerState();
}
//-----------------------------------SplashScreenState------------------------//
class PayCustomerState extends State<PayCustomer> {
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Text(
          GlobalFlag.PayCustomer.toString(),
      ...
      body:WebView(
        initialUrl: GlobalFlag.PayCustomerWebView,
