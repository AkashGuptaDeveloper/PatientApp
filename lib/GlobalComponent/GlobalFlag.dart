...
// ignore: non_constant_identifier_names
  ...
  // ignore: non_constant_identifier_names
  static String DetailsisRequired = "Details is Required";
  // ignore: non_constant_identifier_names
  static String DetailsmustbeNeed = "Details must be Need";
  // ignore: non_constant_identifier_names
  static String PleaseSelectDate = "Please Select Appointment Date";
  // ignore: non_constant_identifier_names
  static String PleaseSelectTime = "Please Select Appointment Time";
  // ignore: non_constant_identifier_names
  static String PleaseSelectService = "Please Select Appointment Service";
  // ignore: non_constant_identifier_names
  static String PleaseWait = "Please Wait";
  // ignore: non_constant_identifier_names
  static String Jsonstatus = "status";
  // ignore: non_constant_identifier_names
