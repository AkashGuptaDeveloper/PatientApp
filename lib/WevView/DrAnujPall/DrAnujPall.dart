...
//------------------------------------START-----------------------------------//
class DrAnujPall extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagDrAnujPall.toString();
  @override
  DrAnujPallState createState() => new DrAnujPallState();
}
//-----------------------------------SplashScreenState------------------------//
class DrAnujPallState extends State<DrAnujPall> {
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      body:WebView(
        initialUrl: GlobalFlag.DrAnujPalWebView,
