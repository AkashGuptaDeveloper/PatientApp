...
//------------------------------------START-----------------------------------//
class Sec7 extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagSec7.toString();
  @override
  Sec7State createState() => new Sec7State();
}
//-----------------------------------SplashScreenState------------------------//
class Sec7State extends State<Sec7> {
