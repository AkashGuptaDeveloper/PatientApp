...
class Sec3 extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagSec3.toString();
  @override
  Sec3State createState() => new Sec3State();
}
//-----------------------------------SplashScreenState------------------------//
class Sec3State extends State<Sec3> {
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      body:WebView(
        initialUrl: GlobalFlag.aureatSphinxLink,
