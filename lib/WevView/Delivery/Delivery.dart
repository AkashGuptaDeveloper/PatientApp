...
class Delivery extends StatefulWidget {
  static String tag = GlobalNavigationRoute.TagDelivery.toString();
  @override
  DeliveryState createState() => new DeliveryState();
}
//-----------------------------------SplashScreenState------------------------//
...
//----------------------------------------------------------------------------//
    return Scaffold(
      ...
      appBar: new AppBar(
        ...
        title: Text(
          GlobalFlag.RequestMedicalDelivery.toString(),
      ...
      body:WebView(
        initialUrl: GlobalFlag.DeliveryWebView,
